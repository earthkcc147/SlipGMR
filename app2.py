...
def select_background(bank_name):
    print_centered("🏦 ทำการเลือกพื้นหลังของสลีป...")
    background()
    print()
    print_centered_boxed_messages(f"เลือกภาพพื้นหลังสำหรับธนาคาร {bank_name}:")
    print_centered(f"เลือกภาพพื้นหลังสำหรับธนาคาร {bank_name}:")

    if bank_name == "K-bank":
        # เพิ่มเมนูในรูปแบบรายการ
        Kbank = [
            "1. K-bank ธรรมดา 🌇",
            "2. K-bank คริสมาสต์ 🌆",
            "3. K-bank ใจเขียว 🌃",
...
def select_logo(background_image):
    ...
    menu_items = [
        ...
        "10. Another Logo 🎨 (โลโก้ธนาคารอื่นๆ)",  # เพิ่มโลโก้ตัวเลือกอื่นๆ ได้
        "00. เริ่มใหม่ 🔄"  # ตัวเลือกสำหรับเริ่มใหม่
    ]
    # เรียกฟังก์ชันเพื่อแสดงเมนูในกรอบ
    print_boxed_menu(menu_items)
