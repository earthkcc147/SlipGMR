...
def signup():
    ...
    if not username or not password:
        ...
        start_menu()  # เริ่มฟังก์ชันใหม่หากข้อมูลไม่ครบ
    ...
    while True:  # วนซ้ำจนกว่าจะได้รับคำตอบที่ถูกต้อง
        confirm = input("\nยืนยันข้อมูลถูกต้องหรือไม่? (y/n): ").strip().lower()
        ...
        if confirm == "y":
            ...
            print("⏪ ยกเลิกการสมัครสมาชิก กำลังกลับไปเมนูหลัก...")
            start_menu()  # กลับไปเมนูหลัก
            break  # ออกจากลูป
        else:
