...
def center_print(text, width):
    # คำนวณช่องว่างซ้ายและขวาเพื่อจัดข้อความตรงกลาง
...
def start_menu():
    ...
    while True:
        # พิมพ์ช่องว่างให้ตรงกลางจอ
        for _ in range(terminal_height // 4):  # ปรับให้เมนูอยู่กลางหน้าจอ
            print()
        ...
        print()  # ช่องว่างใต้เมนูเพื่อไม่ให้ติดกับขอบ
