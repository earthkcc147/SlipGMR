...
# ตัวอย่างฟังก์ชันจำลอง
def select_bank():
    return input("กรุณาเลือกธนาคาร: ")

def select_background(bank_name):
    return f"background_{bank_name}.png"
...
def get_thailand_time():
    from datetime import datetime
    thailand_time = datetime.now().strftime("%d-%m-%Y %H:%M:%S")
