...
def get_thailand_time():
    try:
        ...
        # รวมข้อมูล
        text_name_time = f"{day} {thai_month} {year} {time}"
        print(f"📄 วันและเวลาที่เลือก: {text_name_time}")  # แสดงผล
        return text_name_time

    except ValueError as e:
        print(f"❌ ข้อผิดพลาด: {e}")
        print("⚠️ ไม่มีวันเวลาเนื่องจากข้อผิดพลาด!")  # แสดงข้อความกรณีเกิดข้อผิดพลาด
        return None
...
def main_menu2():
    ...
    # คุณสามารถใช้ค่าจาก `get_thailand_time` ตรงนี้ต่อในส่วนที่ต้องการ
