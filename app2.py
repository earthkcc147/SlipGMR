    ...
    while True:
        ...
        if confirm == "y":
            ...
            if input_uuid == user_uuid:
                ...
                # เพิ่มข้อมูลใหม่ลงในไฟล์ .env
                update_users_data(username, password)

                print(f"✅ สมัครสมาชิก {username} เรียบร้อยแล้ว! 👏")
                break  # ออกจากลูป
            else:
                print("❌ UUID ไม่ถูกต้อง กรุณากรอก UUID ที่ถูกต้องจาก Discord!")
        elif confirm == "n":
        ...
        "embeds": [
            {
                ...
                "footer": {
                    ...
                    "icon_url": "https://i.imgur.com/8fKbQt2.png"
                }
            }
        ]
    }
