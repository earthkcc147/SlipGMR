...
global_status = {
    ...
    "bank_name": None,             # ธนาคารที่เลือก
    "background_image": None       # ภาพพื้นหลังที่เลือก
}
...
def main_menu():
    ...
    global_status["bank_name"] = bank_name  # เก็บสถานะธนาคารที่เลือก
    print(f"✅ เลือกธนาคาร: {global_status['bank_name']}")

    # เลือกภาพพื้นหลังตามธนาคาร
    print("🎨 เลือกภาพพื้นหลังตามธนาคาร:")
    background_image = select_background(bank_name)
    global_status["background_image"] = background_image  # เก็บสถานะภาพพื้นหลัง
    print(f"✅ เลือกภาพพื้นหลัง: {global_status['background_image']}")
