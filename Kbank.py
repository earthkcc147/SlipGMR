...
def select_background():
    ...
    print("\nSCB")
    print("6. SCB ไทยพาณิชย์ 🌅")
    print("\nBangkok")
    print("7. Bangkok กรุงเทพ 🌄")
    print("\nTTB")
    print("8. TTB 🌋")
    print("\nกรุงศรี")
    print("9. กรุงศรี 🌙")
...
def select_logo(background_image):
    print("เลือกธนาคารปลายทาง:")
    print("1. K-bank 🏦")
    print("2. Another Logo 🎨")
    print("3. SCB 💳")
    print("4. Bangkok Bank 🏙️")
    print("5. TTB 💼")
    print("6. กรุงศรี 🏢")
    print("7. กรุงไทย 💰")  # เพิ่มโลโก้ตัวเลือกใหม่
    ...
    if background_image == "Bank/K-bank 4.png":
        ...
        logo_size = (140, 140)
        logo_position = (50, 560)  # ตัวอย่างตำแหน่งโลโก้สำหรับพื้นหลังอื่นๆ
