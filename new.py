...
def login():
    ...
    # ตรวจสอบข้อมูลกับฐานข้อมูล หรือ ตรวจสอบข้อมูลที่เก็บไว้ในโปรแกรม
    # ตัวอย่างการตรวจสอบด้วยข้อมูลตัวอย่าง (สามารถเปลี่ยนเป็นการตรวจสอบจากฐานข้อมูล)
    if username == "user" and password == "password123":
        print("✔️ การล็อกอินสำเร็จ")
        return True
    else:
        print("❌ การล็อกอินไม่สำเร็จ, กรุณาลองใหม่อีกครั้ง")
        return False
...
def main_menu():
    ...
    debug_print("✅ ข้อความทั้งหมดถูกเ